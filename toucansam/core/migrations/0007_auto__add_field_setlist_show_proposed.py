...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SetList.show_proposed'
        db.add_column(u'core_setlist', 'show_proposed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SetList.show_proposed'
        db.delete_column(u'core_setlist', 'show_proposed')
